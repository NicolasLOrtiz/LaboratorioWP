...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_script_add_data( 'newrig-navigation', 'async', true );
		wp_script_add_data( 'newrig-navigation', 'precache', true );
		wp_localize_script(
			'newrig-navigation',
			'newrigScreenReaderText',
			[
				'expand'   => __( 'Expand child menu', 'newrig' ),
				'collapse' => __( 'Collapse child menu', 'newrig' ),
			]
		);
	}
