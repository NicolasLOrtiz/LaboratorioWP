...
Use our button generator to create coupon reveal buttons and display them through shortcodes with the new Gutenberg shortcode block. You can also add it to widgets or any other text editor you prefer.
...
= 1.1.2 =
Changes to the inferface - Fixed a select on click bug - Added upsell - Changes to the responsive design - Updates plugin tags and readme.txt - Added new images
= 1.1.1 =
